...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd('gsettings set org.gnome.desktop.interface gtk-theme "adw-gtw3-dark"')
end)
...
hl.device({
  name = "asustek-computer-inc.-n-key-device-2",
...
hl.bind(mainMod .. " + SHIFT + L", hl.dsp.exec_cmd(menu))
hl.bind(mainMod .. " + M",
